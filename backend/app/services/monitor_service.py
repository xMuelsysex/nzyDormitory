...
class MonitorService:
    ...
    def save_room(self, payload: dict[str, object]) -> dict[str, object]:
        ...
        self.repository.save_room_selection(selection, app_now_iso())
    ...
    def save_schedule(self, payload: dict[str, object]) -> dict[str, object]:
        ...
        self.repository.save_schedule_config(config, app_now_iso())
    ...
    def save_alert(self, payload: dict[str, object]) -> dict[str, object]:
        ...
        self.repository.save_alert_config(config, app_now_iso())
    ...
    def readings(self, page: int = 1, page_size: int = 20) -> dict[str, object]:
        offset = (page - 1) * page_size
        return {
            "items": self.repository.list_readings(limit=page_size, offset=offset),
            "page": page,
            "pageSize": page_size,
            "total": self.repository.count_readings(),
            "currentReading": self.repository.get_latest_successful_reading(),
        }
